...
class RecyclerAdapter(val items: ArrayList<Video>, val context: Context, val videoView: VideoView) :
    ...
    override fun onBindViewHolder(holder: RecyclerAdapter.PhotoHolder, position: Int) {
        ...
        Glide.with(context).load(items.get(position).thumb).error(R.drawable.loaderror)
            .placeholder(R.drawable.loaderror).into(holder.imageView)
